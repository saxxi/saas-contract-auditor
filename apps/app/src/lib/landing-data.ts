...
export const EXAMPLE_1 = `CLIENT ACCOUNT DATASET
...
export const EXAMPLE_2 = JSON.stringify(
  {
...
export const CACHED_NORTHSTAR_REPORT: CachedReport = {
...
export const CACHED_VELOCITY_REPORT: CachedReport = {
  proposition_type: "requires negotiation",
  success_percent: 90,
  intervene: true,
  content: `### Situation
...
export const CACHED_REPORTS = { 1: CACHED_NORTHSTAR_REPORT, 2: CACHED_VELOCITY_REPORT } as const;
